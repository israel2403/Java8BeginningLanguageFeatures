...
public class FileCreateDeleteRename {
    public static void main(String[] args) {
        try {
            ...
            if (!fileCreated) {
                System.out.println(newFile + " coudl not be created.");
            }
            ...
            // Create a new file an rename it
    ...
    private static void printFileDetails(final File newFile) {
        System.out.println("Absolute Path: " + newFile.getAbsoluteFile());
